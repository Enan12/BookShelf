...
<section id="content">
    <div class="row">
        <div>
            <h3 style="color:black; text-align: center"><a  href="index.php">BookShelf</a> Book Upload</h3>
        </div>
            ...
            <form action="uploadprocess.php" method="post" enctype='multipart/form-data'>
                <fieldset class="reg">
                    <div class="form-bottom">
                        ...
                        <div class="form-group">
                            <label class="sr-only" for="form-last-dob" >Published on:</label>
                            <input type="date" name="pubDate" placeholder="dd/mm/yyyy" class="form-last-name form-control" id="form-last-dob">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="sr-only" for="form-last-file" >PDF file:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            <input type="file" name="fileToUpload" id="fileToUpload">
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn btn-submit">Submit!</button>
                            <p class="uploading" hidden="true">Uploading Image... </p>
                            <img src="images/ajax-loader.gif" hidden="true" class="uploading">
                        </div>
                    </div>
                </fieldset>
            </form>
