...
<header>
  <div class="container_12">
    <div class="grid_12">
	<a class="button" href="register.html" style="text-align: right; background-color: #e7e7e7; color: black;">Sign up</a>
      <a class="button" href="login.php" style="text-align: right">Login</a>
      <h1 class="logo">
        <a href="index.php">
          LIGHT
